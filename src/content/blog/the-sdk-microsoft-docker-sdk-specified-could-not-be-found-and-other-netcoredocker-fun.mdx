...
In order to do that I needed to take a currently functional ASP.NET Core site and add docker support. So easy... Right click to win... ![The Sdk Microsoft Docker Sdk Specified Could Not Be Found And Other Netcoredocker Fun](/images/blog/the-sdk-microsoft-docker-sdk-specified-could-not-be-found-and-other-netcoredocker-fun-1758985196416-0.png) After Visual Studio added the DockerFile and the Docker-Compose scripts, I clicked on the Continuous Delivery Extension and configured the release to deploy using an Azure App Service for Linux. The resulting build would submit a Docker Image to my Azure Container Registry and the Azure App Service for Linux would host this as content.
...
![The Sdk Microsoft Docker Sdk Specified Could Not Be Found And Other Netcoredocker Fun](/images/blog/the-sdk-microsoft-docker-sdk-specified-could-not-be-found-and-other-netcoredocker-fun-1758985196474-2.png)
...
![The Sdk Microsoft Docker Sdk Specified Could Not Be Found And Other Netcoredocker Fun](/images/blog/the-sdk-microsoft-docker-sdk-specified-could-not-be-found-and-other-netcoredocker-fun-1758985196499-3.png)
