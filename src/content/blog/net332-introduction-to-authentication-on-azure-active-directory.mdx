---
title: "NET332 &ndash; Introduction to Authentication on Azure Active Directory"
date: "2017-02-27"
excerpt: ""
tags: [".NET", "Identity"]
readingTime: 10
...
# NET332 &ndash; Introduction to Authentication on Azure Active Directory
...
Since the resulting code for working with both authentication libraries is what’s important here, please check in at (https://github.com/slamb2k/NET332) to grab the final results.

!(http://welltechnically.com/wp-content/uploads/2017/02/image-15.png)

The original application is included in the (https://github.com/slamb2k/NET332/tree/master) branch and the **_(https://github.com/slamb2k/NET332/tree/ADAL)_**  and **_(https://github.com/slamb2k/NET332/tree/MSAL)_** conversions are checked into their own distinct branches.
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894598842.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894599966.png "clip_image002")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894599442.png)**
...
Up until recently the authentication endpoints supported only accounts from Azure Active Directory but at Build 2016 the new (https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-appmodel-v2-overview) was introduced to also support Microsoft Accounts. Before this authentication system was released, application developers were required to register two applications, use two separate  authentication libraries and connect to two unique endpoints if there was a requirement to support both AAD and MSA. There are documented (https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-v2-compare) between the two endpoints and the two (https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-v2-libraries) presented in this article  demonstrate unique approaches to using these distinct endpoints.

The new converged authentication APIs do have (https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-v2-limitations) but the current recommendations are as follows:
...
-   If your application needs to support only work and school accounts, use (https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-developers-guide).
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894600527.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894601609.png "clip_image004")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894601052.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894602286.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894604476.png "clip_image006")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894603490.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894604996.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894605990.png "clip_image008")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894605538.png)**

This msapp:// style URI should be then added as a redirect URI to the newly created application.

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894606460.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894607500.png "clip_image010")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894606885.png)**

We also need to delegate permission from this new Native App Registration to use our Web API App Registration:

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894607884.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894608711.png "clip_image012")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894608267.png)**

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894609102.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894610057.png "clip_image014")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894609583.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894610901.png "image")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894610437.png)

Once this is complete you will be logged in and can add gifts until your heart is content:

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894611378.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894613104.png "clip_image018")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894612276.png)**
...
The initialisation logic requires a special class which is available from several repositories such as (https://github.com/oktadeveloper/okta-oauth-aspnet-codeflow/blob/master/Api/OpenIdConnectCachingSecurityTokenProvider.cs) and this class needs to be added to the project as well.

As this application will use the new converged API experience we need to register it in the new (https://apps.dev.microsoft.com). In this portal you can see any old Live SDK registrations as well as any applications using the V2 endpoints.

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894613634.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894614789.png "clip_image020")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894614103.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894615428.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894616464.png "clip_image022")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894616007.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894616901.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894617849.png "clip_image024")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894617437.png)**
...
(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894618287.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894619186.png "clip_image026")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894618717.png)**

The end result is a Christmas list keyed off my Microsoft Account rather than an organizational one:

(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894619650.png)**(/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894621415.png "clip_image028")](/images/blog/net332-introduction-to-authentication-on-azure-active-directory-1758894620950.png)**
