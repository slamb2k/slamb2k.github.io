...
const HeroSection: React.FC = () => {
  ...
  return <motion.section initial={{
    ...
    duration: 0.8
  }} className="min-h-screen flex flex-col justify-center mb-24 relative">
      <div className="space-y-6">
        ...
        delay: 0.6
          ...
          scale: 0.95
        }} onClick={scrollToAbout} className="group inline-flex items-center space-x-2 px-8 py-4 border border-teal-300 text-teal-300 rounded-lg hover:bg-teal-300/10 transition-all duration-300">
            <span className="font-mono text-sm">Check out my work!</span>
