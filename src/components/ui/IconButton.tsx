...
const IconButton: React.FC<IconButtonProps> = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-teal-300/50 disabled:opacity-50 disabled:cursor-not-allowed';
